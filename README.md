...
#### 15. [Move all the even integers at the beginning of the array followed by all the odd integers](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/SortArrayByParity.java)
#### 16. [Sort an array of 0s, 1s and 2s](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/SortArrayOf_012.java)
#### 17. [Lemonade change problem](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/LemonadeChange.java)
#### 18. [Check if the array is sorted and rotated](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/IsSortedAndRotatedArray.java)
#### 19. [Find a maximum repeated element in an array](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/FindMaximumRepeatedElement.java)
#### 20. [Print all unique elements from an array](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/FindAllUniqueElements.java)
#### 21. [Check if two arrays are equal or not](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/CheckTwoArraysEqualOrNot.java)
#### 22. [Find the missing number in an array](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/MissingNumber.java)
#### 23. [Remove duplicate elements from sorted array](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/RemoveDuplicatesFromSortedArray.java)
#### 24. [Find the index where the target would be if it were inserted in order](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/SearchInsertPosition.java)
#### 25. [Find Duplicate Number from an array in linear time](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/FindDuplicateNumberInLinearTime.java)
#### 26. [Remove all occurrences of val in given array in-place](https://github.com/sneha-tarnekar/java-data-structure-algo/blob/main/src/Arrays/RemoveGivenElement.java)
